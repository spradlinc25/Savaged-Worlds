---
title: SWADE Character Edges
type: rules_reference
category: character_creation
description: This file contains the complete list of character Edges for Savage Worlds Adventure Edition (SWADE). It includes Background, Combat, Leadership, Power, Professional, Social, and Weird Edges. It details the Rank requirements, Attribute/Skill prerequisites, and mechanical effects for each Edge. Claude should reference this file to verify character build legality and to calculate modifier stacking (e.g., +1 to Parry, +2 to Notice) for derived stats and skill rolls.
---

# Edges
Edges represent special abilities, learned skills, or innate talents that set a character apart from the average person. 

## Requirements
Below is a list of Edges grouped by category. You’ll find their requirements, if any, along with a brief description of their effects.
* **Rank:** A character must have the Rank indicated or higher to choose the Edge. 
* **Attributes/Skills:** If an Edge requires a specific Trait (Attribute or Skill), it means the character must have that Trait at the listed die type or higher.

---

## Background Edges
Background Edges may be chosen only at character creation unless the GM allows otherwise (such as finding a mentor or achieving a specific narrative milestone).
...
## Combat Edges
These Edges are designed to help characters dish out damage, survive injuries, or outmaneuver opponents in a fight.
...
## Leadership Edges
Leadership Edges grant bonuses to allies, making them highly effective for characters who command troops or lead the party. Unless otherwise noted, Leadership Edges apply to all allies within the character's Command Range (5 inches/10 yards).
...
## Power Edges
These Edges are exclusively for characters who have an Arcane Background, granting them deeper reserves of energy, new abilities, or specialized casting techniques.
...
## Professional Edges
Professional Edges represent years of practice or intense training. They often provide significant bonuses to specific skills or situations.
...
## Social Edges
Social Edges help characters navigate negotiations, intimidate foes, or rally allies through words and presence.
...
## Weird Edges
Weird Edges are slightly supernatural or require a bit of explanation as to how the character acquired them. They often represent innate abilities, mutations, or strange luck.
...
## Legendary Edges
Legendary Edges are the pinnacle of achievement, available only to characters who have reached Legendary Rank (80+ Advances). 
...
## Master Edges Summary Table

| Category         | Edge                     | Requirements                                          | Summary                                                             |
| :--------------- | :----------------------- | :---------------------------------------------------- | :------------------------------------------------------------------ |
| **Background**   | Alertness                | Novice                                                | +2 to Notice rolls                                                  |
| **Background**   | Ambidextrous             | Novice, Ag d8+                                        | Ignore -2 off-hand penalty                                          |
| **Background**   | Arcane Background        | Novice                                                | Gain Arcane Background                                              |
| **Background**   | Aristocrat               | Novice                                                | +2 Common Knowledge (etiquette), free reroll Persuasion (own class) |
| **Background**   | Attractive               | Novice, V d6+                                         | +1 Performance and Persuasion                                       |
| **Background**   | Very Attractive          | Novice, Attractive                                    | +2 Performance and Persuasion                                       |
| **Background**   | Brawny                   | Novice, St d6+, V d6+                                 | Size +1, treat Str as one step higher for Encumbrance               |
| **Background**   | Fast Healer              | Novice, V d8+                                         | +2 Vigor for natural healing                                        |
| **Background**   | Fleet-Footed             | Novice, Ag d6+                                        | Pace +2, running die +1 step                                        |
| **Background**   | Linguist                 | Novice, Sm d6+                                        | Know languages = half Smarts, +2 to understand unknown languages    |
| **Background**   | Luck                     | Novice                                                | +1 Benny per session                                                |
| **Background**   | Great Luck               | Novice, Luck                                          | +2 Bennies per session                                              |
| **Background**   | Quick                    | Novice, Ag d8+                                        | Redraw Action Cards of 5 or lower                                   |
| **Background**   | Rich                     | Novice                                                | 3x starting funds, comfortable lifestyle                            |
| **Background**   | Filthy Rich              | Novice, Rich                                          | 5x starting funds, high lifestyle                                   |
| **Combat**       | Berserk                  | Novice, Sm d6+                                        | +2 Fighting/Strength/Toughness, -2 Parry, ignore Wound penalties    |
| **Combat**       | Block                    | Seasoned, F d8+                                       | +1 Parry, ignore 1 Gang Up bonus                                    |
| **Combat**       | Improved Block           | Veteran, Block                                        | +2 Parry, ignore 2 Gang Up bonuses                                  |
| **Combat**       | Brawler                  | Novice, St d8+, V d8+                                 | Unarmed damage Str+d4                                               |
| **Combat**       | Bruiser                  | Seasoned, Brawler                                     | Toughness +1, Unarmed damage Str+d8                                 |
| **Combat**       | Combat Reflexes          | Seasoned                                              | +2 Spirit to recover from Shaken                                    |
| **Combat**       | Counterattack            | Seasoned, F d8+                                       | Free Attack per round against failed Fighting attack                |
| **Combat**       | Improved Counterattack   | Veteran, Counterattack                                | Free Attack against all failed Fighting attacks                     |
| **Combat**       | Dead Shot                | WC, Seasoned, Ath/Sho/WS d8+                          | Double damage on Joker                                              |
| **Combat**       | Dodge                    | Seasoned, Ag d8+                                      | -2 to Ranged attacks against the hero                               |
| **Combat**       | Improved Dodge           | Veteran, Dodge                                        | -2 Ranged attacks against hero, +2 Evasion                          |
| **Combat**       | Elan                     | Novice, Sp d8+                                        | +2 when spending a Benny to reroll a Trait                          |
| **Combat**       | Extraction               | Novice, Ag d8+                                        | One opponent doesn't get Free Attack when retreating                |
| **Combat**       | Improved Extraction      | Seasoned, Extraction                                  | All opponents don't get Free Attacks when retreating                |
| **Combat**       | First Strike             | Novice, Ag d8+                                        | Free Attack against one foe moving adjacent                         |
| **Combat**       | Improved First Strike    | Heroic, First Strike                                  | Free Attack against every foe moving adjacent                       |
| **Combat**       | Frenzy                   | Seasoned, F d8+                                       | 1 extra Fighting attack at -2                                       |
| **Combat**       | Improved Frenzy          | Veteran, Frenzy                                       | 1 extra Fighting attack at no penalty                               |
| **Combat**       | Giant Killer             | Veteran                                               | +1d6 damage vs Size +3 or larger                                    |
| **Combat**       | Hard to Kill             | Novice, Sp d8+                                        | Ignore Wound penalties for Incapacitation rolls                     |
| **Combat**       | Harder to Kill           | Veteran, Hard to Kill                                 | 50% chance to survive death                                         |
| **Combat**       | Level Headed             | Seasoned, Sm d8+                                      | Draw 2 Action Cards, keep best                                      |
| **Combat**       | Improved Level Headed    | Seasoned, Level Headed                                | Draw 3 Action Cards, keep best                                      |
| **Combat**       | Marksman                 | Seasoned, Ath/Sho d8+                                 | Ignore 2 points of penalties if not moving                          |
| **Combat**       | Martial Artist           | Novice, F d6+                                         | Unarmed Str+d4, +1 Fighting when unarmed                            |
| **Combat**       | Martial Warrior          | Seasoned, Martial Artist, F d8+                       | Unarmed Str+d6, +2 Fighting when unarmed                            |
| **Combat**       | Mighty Blow              | WC, Seasoned, F d10+                                  | Double Fighting damage on Joker                                     |
| **Combat**       | Nerves of Steel          | Novice, V d8+                                         | Ignore 1 point of Wound penalties                                   |
| **Combat**       | Improved Nerves of Steel | Novice, Nerves of Steel                               | Ignore 2 points of Wound penalties                                  |
| **Combat**       | No Mercy                 | Seasoned                                              | Spend a Benny to reroll damage                                      |
| **Combat**       | Quick Draw               | Novice, Ag d8+                                        | Draw weapon as free action, +2 Ath/Sho if already drawn             |
| **Combat**       | Rapid Fire               | Seasoned, Sho d8+                                     | 1 extra Shooting attack at -2                                       |
| **Combat**       | Improved Rapid Fire      | Veteran, Rapid Fire                                   | 1 extra Shooting attack at no penalty                               |
| **Combat**       | Steady Hands             | Novice, Ag d8+                                        | Ignore unstable platform penalties                                  |
| **Combat**       | Sweep                    | Novice, St d8+, F d8+                                 | Attack all adjacent foes at -2                                      |
| **Combat**       | Improved Sweep           | Veteran, Sweep                                        | Attack all adjacent foes at no penalty                              |
| **Combat**       | Trademark Weapon         | Novice, F/Sho d8+                                     | +1 Trait roll with weapon, +1 Parry                                 |
| **Combat**       | Two-Fisted               | Novice, Ag d8+                                        | Make one attack with each hand, ignore Multi-Action penalty         |
| **Combat**       | Two-Weapon Fighting      | Novice, Ag d8+                                        | Ignore Multi-Action penalty for second attack                       |
| **Leadership**   | Command                  | Novice, Sm d6+                                        | +1 to allies' Spirit rolls to recover from Shaken                   |
| **Leadership**   | Command Presence         | Seasoned, Command                                     | Command Range increased to 10"                                      |
| **Leadership**   | Fervor                   | Veteran, Sp d8+, Command                              | +1 Fighting/Shooting damage for allies                              |
| **Leadership**   | Hold the Line!           | Seasoned, Sm d8+, Command                             | +1 Toughness for allies                                             |
| **Leadership**   | Inspire                  | Seasoned, Command                                     | May Support an ally in Command Range as a free action               |
| **Leadership**   | Master Tactician         | Veteran, Tactician                                    | Draw 2 extra Action Cards for allies                                |
| **Leadership**   | Natural Leader           | Seasoned, Command                                     | May share Bennies with allied Extras                                |
| **Leadership**   | Tactician                | Seasoned, Sm d8+, Command                             | Draw 1 extra Action Card for an ally                                |
| **Power**        | Extra Effort             | Seasoned, Arcane Background                           | Spend extra PP for +1 or +2 on arcane roll                          |
| **Power**        | Holy/Unholy Warrior      | Seasoned, AB (Miracles), Sp d8+                       | Spend 1 PP to Shake/Wound evil/good creatures                       |
| **Power**        | New Powers               | Novice, Arcane Background                             | Learn two new powers                                                |
| **Power**        | Power Points             | Novice, Arcane Background                             | +5 max Power Points                                                 |
| **Power**        | Rapid Recharge           | Seasoned, Sp d6+, AB                                  | Regain 10 PP every hour                                             |
| **Power**        | Improved Rapid Recharge  | Veteran, Rapid Recharge                               | Regain 20 PP every hour                                             |
| **Professional** | Acrobat                  | Novice, Ag d8+, Ath d8+                               | Free reroll acrobatics, +1 Parry                                    |
| **Professional** | Assassin                 | Novice, Ag d8+, F d6+, Ste d8+                        | +2 damage to Vulnerable foes or with the Drop                       |
| **Professional** | Gadgeteer                | Seasoned, AB (Weird Science), Sm d8+, Rep d8+, WS d8+ | "Jury-rig" a device once per session                                |
| **Professional** | Investigator             | Novice, Sm d8+, Res d8+                               | Free reroll on Notice (searching) and Research                      |
| **Professional** | Jack-of-All-Trades       | Novice, Sm d10+                                       | Ignore unskilled penalty for Smarts-based skills                    |
| **Professional** | McGyver                  | Novice, Sm d6+, Rep d6+, Not d8+                      | Create makeshift devices                                            |
| **Professional** | Mentalist                | Novice, AB (Psionics), Sm d8+, Psi d6+                | +2 Psionics vs Smarts/Spirit                                        |
| **Professional** | Mr. Fix-It               | Novice, Sm d8+, Rep d8+                               | +2 Repair, halve Repair time                                        |
| **Professional** | Scholar                  | Novice, Res d8+                                       | +2 to one specific Smarts-based skill                               |
| **Professional** | Thief                    | Novice, Ag d8+, Ste d8+, Thi d8+                      | +1 to Stealth and Thievery in urban areas                           |
| **Professional** | Wizard                   | Novice, AB (Magic), Sm d8+, Spell d6+                 | Raises reduce PP cost by 1                                          |
| **Professional** | Woodsman                 | Novice, Sp d6+, Sur d8+                               | +2 to Survival and Stealth in the wilderness                        |
| **Social**       | Bolster                  | Novice, Sp d8+                                        | Test removes Distracted/Vulnerable from an ally                     |
| **Social**       | Charismatic              | Novice, Sp d8+                                        | Free reroll on Persuasion                                           |
| **Social**       | Common Bond              | Novice, Sp d8+                                        | May give Bennies to other player characters                         |
| **Social**       | Humiliate                | Novice, Tau d8+                                       | Target is Distracted and loses Free Attack on Raise                 |
| **Social**       | Menacing                 | Novice, Int d8+                                       | +2 to Intimidation                                                  |
| **Social**       | Provoke                  | Novice, Tau d8+                                       | Target must attack hero or suffer -2                                |
| **Social**       | Rabble-Rouser            | Seasoned, Sp d8+                                      | Social skills affect Medium Blast Template                          |
| **Social**       | Reliable                 | Novice, Sp d8+                                        | Free reroll on Support rolls                                        |
| **Social**       | Retort                   | Novice, Tau d6+                                       | Opponent is Distracted on failed Test against hero                  |
| **Social**       | Streetwise               | Novice, Sm d6+                                        | Free reroll Networking, +2 street-level interactions                |
| **Social**       | Strong Willed            | Novice, Sp d8+                                        | +2 to resist Tests with Smarts or Spirit                            |
| **Weird**        | Beast Bond               | Novice                                                | Spend Bennies on animals under control                              |
| **Weird**        | Beast Master             | Novice, Sp d8+                                        | Gain a loyal animal companion                                       |
| **Weird**        | Champion                 | Novice, Sp d8+, AB (Miracles)                         | +2 damage vs supernaturally evil/good                               |
| **Weird**        | Chi                      | Veteran, Martial Artist, F d10+                       | Spend Benny to ignore all penalties for turn                        |
| **Weird**        | Combat Sense             | Seasoned, F d8+                                       | Opponents' Gang Up bonuses reduced by 1                             |
| **Weird**        | Improved Combat Sense    | Veteran, Combat Sense                                 | Opponents' Gang Up bonuses reduced by 2                             |
| **Weird**        | Danger Sense             | Novice                                                | Notice roll at -2 to detect ambushes                                |
| **Weird**        | Healer                   | Novice, Sp d8+                                        | +2 to Healing rolls                                                 |
| **Weird**        | Liquid Courage           | Novice, V d8+                                         | Alcohol increases Vigor die, -2 Smarts/Agility                      |
| **Legendary**    | Expert                   | Legendary, Professional                               | Trait increases to d12+2                                            |
| **Legendary**    | Followers                | Legendary                                             | Attract 5 loyal followers                                           |
| **Legendary**    | Master                   | WC, Legendary, Expert                                 | Wild Die for chosen Trait becomes d10                               |
| **Legendary**    | Master of Arms           | Legendary, Weapon Master                              | +1 Parry, ignore 2 Gang Up bonuses                                  |
| **Legendary**    | Professional             | Legendary, d12 Trait                                  | Trait becomes d12+1                                                 |
| **Legendary**    | Sidekick                 | Legendary                                             | Gain a Novice Rank WC sidekick                                      |
| **Legendary**    | Tough as Nails           | Legendary, V d8+                                      | Take 4 Wounds before Incapacitation                                 |
| **Legendary**    | Improved Tough as Nails  | Legendary, Tough as Nails                             | Take 5 Wounds before Incapacitation                                 |
| **Legendary**    | Weapon Master            | Legendary, F d12+                                     | +1 Parry, +1 Fighting                                               |